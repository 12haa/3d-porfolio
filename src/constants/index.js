...
const projects = [
  {
    ...
    description:
      "Article Summarizer  App that receives a link and summarizes the article related to the link given.",
    tags: [
      {
        name: "React",
  ...
  },
  {
    name: "SnapGram",
    description:
      'A Social Media Called "SnapGram" which in users can post , like , comment and scroll to see posts and save their favorite post.',
    tags: [
      {
        name: "Tailwind",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    live_demo_link:
      "https://task-guru-b7w3l95vi-mkhaefi2500-yahoocom.vercel.app/",
  },
  {
    name: "Youtube Clone",
    description:
    ...
    image: YoutubeClone,
    source_code_link: "https://github.com/12haa/Youtube-Clone",
    live_demo_link: "https://youtube-clone-tau-opal.vercel.app/",
  },
